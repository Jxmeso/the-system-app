...
- 2026-07-01: Added the v6 product surface: responsive navigation, a fully described feature hub, media-led command dashboard, completion charts, task queue, photo strip, gallery-style Evidence Bank, clearer labels, responsive sheets, and reduced-motion support.
